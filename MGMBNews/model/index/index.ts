...
export default class model
{
  ...
  */
  catchShowTemp=(val:pub.NewsCtr,open:string)=>
  {
     ...
     * @param val 
     */
    moreData=(val:pub.NewsCtr)=> docload.NEWSmoreData(val,"Newsvue",'SeRloadPhoto');
    ...
    getFileFirst=(val:pub.NewsCtr,fun:(obj:pub.NewsCtr)=>void)=>
    {
        ...
        Login(x2 => x2.post("/ns/main/data/newsfilefirst/"+val.key+"_"+ main.pub.langNu+"_"+val.uid).input({"contentList":JSON.stringify(newDoc)}),(obj2:any)=>
        {//載入段落 file
