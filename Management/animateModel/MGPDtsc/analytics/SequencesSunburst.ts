...
export default (d3:any,csvRowData:Array<Array<string>>,colors:getChartColorName)=>{
    ...
    var vis = d3.select("#PayDayChart").append("svg:svg")
        .attr("width", width)
        .attr("height", height)
        .append("svg:g")
        .attr("id", "container")
    ...
    function mouseover(d:any) {
        ...
        d3.select("#PayDaypercentage")
            .text(percentageString);

        d3.select("#PayDayexplanation")
            .style("visibility", "");
    ...
    // Add the svg area.
    var trail = d3.select("#PayDaysequence").append("svg:svg")
        .attr("width", width)
        .attr("height", 50)
        .attr("id", "trail");
    ...
    /** bunild list */
    function toH(childNode:DataChart,nu:number,parts:Array<string>):DataChart
    {
    ...
    d3.select("#PayDayChart").style("height", "350px");
}