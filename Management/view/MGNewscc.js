...
this.vue = {
    ...
    temp:function($t){ 
        return {
            toolvue:$t.import("@temp/MGNewscc/tool")//文章搜尋 工具
            .exportVue({
                main:$t.main,
                mainTemp:$t.mainTemp,
                main$m:$t,//指自己
            }),
            autoeditvue:$t.import("@temp/MGNewscc/autoedit")//自動審核設定
            .exportVue({
                main:$t.main,
                mainTemp:$t.mainTemp,
                main$m:$t,//指自己
            }),
            classvue:$t.import("@temp/MGNewscc/class")//文章分類設定
            .exportVue({
                main:$t.main,
                mainTemp:$t.mainTemp,
                main$m:$t,//指自己
            }),
            editvue:$t.import("@temp/MGNewscc/edit")//審核文章
            .exportVue({
                main:$t.main,
                mainTemp:$t.mainTemp,
                main$m:$t,//指自己
